...
For the remote repository, make a github repository named HW1_AAP_PDalvi, then do;

```bash
git remote add origin git@github.com:PrachiSDalvi/HW1_AAP_PDalvi.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── HW1_AAP_PDalvi	<- Your notebooks and scripts will live in the main project folder
